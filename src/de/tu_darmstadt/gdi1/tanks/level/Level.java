...
public class Level {
     ...
     */
    public Level(Map m, Border[] b, Tank p, Tank[] o, Wall[] w, Mine[] mine, Pickup[] pickup) {
        this.gameBorder = b;
        this.gameMap = m;
        this.gameTankO = o;
        this.gameTankP = p;
    ...
    public String toString() {
        ...
        for (Pickup  pickup : this.gamePickup) {
            sb.append("\n").append(pickup.toString());
        }
    ...
    /**
     * Get the levels pickups
     *
     * @return
     */
    public Pickup[] getGamePickup() {
        return this.gamePickup;
    }
    /**
     * Set the levels pickups
     *
     * @param pickup
     */
    public void setGamePickup(Pickup[] pickup) {
        this.gamePickup = pickup;
    }
}
